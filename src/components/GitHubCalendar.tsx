...
// Hook to detect system color mode
function useSystemColorMode(): 'dark' | 'light' {
...
export default function GitHubCalendar({ username }: GitHubCalendarProps) {
  ...
  const activityColors = isDark
    ...
    : [
      ...
      { label: 'Low', color: '#9be9a8' },
      { label: 'Medium', color: '#40c463' },
      { label: 'High', color: '#30a14e' },
      { label: 'Very high', color: '#216e39' },
    ];
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="mt-12 mx-auto rounded-2xl border border-gray-200/50 dark:border-gray-700/50 bg-white dark:bg-gray-900 shadow-xl bg-opacity-90 hover:shadow-xl transition-all duration-300 p-8 backdrop-blur-sm"
    >
      <motion.div variants={itemVariants} className="mb-6">
        ...
        <p className="text-sm text-gray-800 dark:text-gray-400 text-center mt-2">
